...
import Colors from "../components/mdx/Colors.astro";
import Fonts from "../components/mdx/Fonts.astro";
...
Finally, I like programming and testing things. Building a blog helped me get rid of a hitch I had for a long time. I was able to experiment with new technologies (for me), spend too much time on color and font.
...
Finally, I need a mono font for the code snippet. I switch between [Berkeley Mono
](https://usgraphics.com/products/berkeley-mono), [Cartograph](https://connary.com/cartograph.html) and [Ellograph](https://connary.com/fonts/ellograph/) in my code editor. I decided to use Berkeley Mono on the blog as it offers a great contrast with Swiss Works.
