...
![Creating a baseline is critical for investigations](../assets/articles/reduce-next-js-bundle/flavien_bonvin_baseline.webp "Creating a baseline is critical for investigations")
...
![Bundle analysis will highlight heavy dependencies](../assets/articles/reduce-next-js-bundle/flavien_bonvin_05_bundle_size_analysis.webp "Bundle analysis will highlight heavy dependencies")
...
![In the end the app was trimmed down about 30%](../assets/articles/reduce-next-js-bundle/flavien_bonvin_final_table.webp "In the end the app was trimmed down about 30%")
