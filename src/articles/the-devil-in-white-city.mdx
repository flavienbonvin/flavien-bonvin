...
import WhiteCity from "../components/mdx/bookReview/WhiteCity.astro";
import { Image } from "astro:assets";
import bookCover from "../assets/articles/the-devil-in-white-city/the-devil-in-white-city.jpg";
