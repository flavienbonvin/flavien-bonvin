...
import AstroNextJSRouting from "@ui/mdx/folder-structure/astro-nextjs-routing.astro";
import ContentCollectionStructure from "@ui/mdx/folder-structure/content-collection-structure.astro";
