...
I’ll probably make a more in-depth review of my purchase when I am more used to everything in the future. Meanwhile, I hope to continue testing new coffees, find the proper settings, and enjoy making a few coffees a day.import { Image } from "astro:assets";
import niceCrema from "../assets/going-manual-with-my-espressos-the-best-decision-i-made/amazing_crema.png";
import coffeeAfterExtraction from "../assets/going-manual-with-my-espressos-the-best-decision-i-made/coffee_right_after_estraction.png";import { Image } from "astro:assets";
import niceCrema from "../assets/going-manual-with-my-espressos-the-best-decision-i-made/amazing_crema.png";
import coffeeAfterExtraction from "../assets/going-manual-with-my-espressos-the-best-decision-i-made/coffee_right_after_estraction.png";
